...
DECLARE @catalogue_number VARCHAR(100), @Title VARCHAR(2000), @Creation_Date VARCHAR(100), 
    ...
    @Birth_Date VARCHAR(50), @Death_Date VARCHAR(50), @Artist_ID VARCHAR(1000), @Provenance_Text VARCHAR(8000), 
...
BEGIN
    ...
    VALUES (@artID, 1); -- Hardcoded to CMOA_cmoa
...
PRINT 'Processing complete. Added ' + CONVERT(VARCHAR, @RecordCount) + ' records from source file: CMOA_cmoa';
